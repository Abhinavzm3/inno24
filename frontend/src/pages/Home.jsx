...
const Home = () => {
    ...
    <div   >
      ...
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
        ...
        <section className="py-20 bg-gray-800 text-white">
          <h2 className="text-4xl text-center text-cyan-400 font-bold tracking-wide mb-10">Hero Testimonials</h2>
          <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
            {[
              { quote: 'Joining the Avengers has been the greatest honor of my life.', author: 'Captain America' },
              { quote: 'With great power comes great responsibility.', author: 'Spider-Man' },
              { quote: 'Science saved the day yet again!', author: 'Iron Man' },
            ].map((testimonial, index) => (
              <div key={index} className="flex flex-col items-center bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                <p className="text-xl italic text-gray-300">"{testimonial.quote}"</p>
                <p className="mt-4 font-bold text-cyan-400">- {testimonial.author}</p>
              </div>
            ))}
          </div>
        {/* </section> */}
  ...
  <h2 className="text-4xl text-center text-cyan-400 font-bold tracking-wide mt-20 mb-10">Join Us</h2>
  ...
  <ol className="list-decimal list-inside max-w-2xl mx-auto text-gray-400 space-y-2">
    ...
    <li>Step 4: Onboarding & Training</li>
        ...
        <section className="py-20 bg-black">
          <h2 className="text-4xl text-center text-cyan-400 font-bold tracking-wide mb-10">Apply Now</h2>
        ...
        <footer className="py-6  bg-gray-900 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Avengers Initiative. All rights reserved.</p>
        </footer>
      </div>
